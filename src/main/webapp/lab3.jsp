...
<html>
    ...
    <body>
        ...
        <form id=”rectangleForm” name=”rectangleForm” method="POST" action=lab3Controller?action=rectangleForm >
        ...
        <form id=”circleForm” name=”circleForm” method="POST" action=lab3Controller?action=circleForm >
        ...
        <form id=”triangleForm” name=”triangleForm” method="POST" action=lab3Controller?action=triangleForm >
